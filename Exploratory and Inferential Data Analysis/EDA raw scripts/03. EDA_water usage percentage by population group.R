...
#1. Reshape population data and calculate average
...
#2. Function to merge and reshape datasets
...
#6. Calculate average usage by population group and year
