...
#1. Merge water_stress with IncomeGroup data
merged_data <- merge(water_stress, info, by = "Country.Code", all.x = TRUE)

#2. Calculate geometric mean of water stress by IncomeGroup and Year
...
#4. Plot geometric mean of water stress by IncomeGroup
